 ...
 */
class Valutationproduct extends \Magento\Catalog\Model\AbstractModel implements
    IdentityInterface,
    SaleableInterface,
    ProductInterface
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'drc_preorder';

    /**
     * @var string
     */
    protected $_eventObject = 'valutationproduct';
	...
	$this->_init('Drc\PreOrder\Model\ResourceModel\Valutationproduct');
        parent::__construct(
            $context,
            $registry,
            $extensionFactory,
